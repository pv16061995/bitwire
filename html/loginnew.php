...
if (isset($_POST['btnlogin'])) {
  ...
  'http' => array(
    ...
    if ($responseData['statusCode'] != 401 && $responseData['user']['tfastatus']==true) {
      ...
      if($_SESSION['KYC_status']===true)
      {
        header("location:index.php?curr=".base64_encode('inrw') );
      } else{
